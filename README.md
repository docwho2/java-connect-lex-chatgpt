...
- By this time (since several seconds have elapsed playing prompts) we check contact attributes that may have been set by [NewCallLookup](NewCallLookup/src/main/java/cloud/cleo/connectgpt/NewCallLookup)
- In this example if contact attribute "PlayPrompt" has a value of "true" we proceed to play a prompt that was generated by NewCallLookup Lambda
